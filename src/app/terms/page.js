export const metadata = {
  title: "Terms of Service | Go Mail Pilot",
  description:
    "Read the terms that govern use of Go Mail Pilot email hosting services.",
};
        ...
        <article className="mt-6 rounded-[2rem] border border-white/80 bg-white p-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)] sm:p-10">
          ...
          <div className="mt-8 space-y-8 text-sm leading-7 text-slate-600 sm:text-base">
            <section>
              ...
              <p className="mt-3">
                Go Mail Pilot provides business email hosting and related support services. By
            ...
            <section>
              ...
              <p className="mt-3">
                To the maximum extent permitted by law, Go Mail Pilot is not liable for
